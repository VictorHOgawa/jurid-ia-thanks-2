...
import useOnScreen from "@/src/utils/IsOnScreen";
...
export function Team() {
  ...
  return (
    <div className="flex h-max w-full flex-col items-center justify-center bg-secondary">
      <div className="relative h-full w-full py-8 lg:h-3/5">
        ...
        >
          {slides.map((item, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 z-20 h-20 w-full bg-gradient-to-b from-transparent to-secondary/20 backdrop-blur-[1px]" />
        ...
        <div
          ref={ref1}
          className="mx-auto mt-8 flex w-11/12 items-center justify-between gap-8 text-secondary"
        >
          <div
            className={twMerge(
